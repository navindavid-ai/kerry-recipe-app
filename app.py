...
# ---------- Home Page ----------
with st.container():
    st.title("🏠 Welcome to the Cell Bank Cloud")
    st.markdown("""
    ### 🧬 Manage Your Cell Line Repository

    This app helps you:
    - Register **Parental Cell Lines**
    - Create and track **Derived Cell Lines**
    - Build and manage **Cell Banks**
    - Log and edit **Vial inventories**

    🧪 Built for research labs, powered by **Streamlit** and **PostgreSQL (Supabase)**.
...
# Existing logic continues below... (no changes to the rest of the code yet)
